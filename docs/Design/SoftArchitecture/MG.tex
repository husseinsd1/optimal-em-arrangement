...
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The format of the
  initial input data.
\item[\refstepcounter{acnum} \actheacnum \label{acPhysParams}:] The physical constraints on the EM parameters.
\item[\refstepcounter{acnum} \actheacnum \label{acAlgUpd}:] Updates to the optimization algorithm. 
\item[\refstepcounter{acnum} \actheacnum \label{acParams}:] Changes to the solver parameters.
\item[\refstepcounter{acnum} \actheacnum \label{acOutputFormat}:] Modification of output format and/or data type. 
\end{description}
...
\begin{description}
\item[\refstepcounter{ucnum} \uctheucnum \label{ucIO}:] I/O devices
  (Input: File and/or Keyboard, Output: File, Memory, and/or Screen).
  \item[\refstepcounter{ucnum} \uctheucnum \label{ucSolApprox}:] Changing the underlying solenoid approximation model.
  \item[\refstepcounter{ucnum} \uctheucnum \label{ucFieldForce}:] Magnetic field and force equations.
  \item[\refstepcounter{ucnum} \uctheucnum \label{ucObjFunc}:] Modifications to the objective function. 
\end{description}
...
\item [\refstepcounter{mnum} \mthemnum \label{mConsParams}:] Constant Parameters Module
\item [\refstepcounter{mnum} \mthemnum \label{mInputParams}:] Input Parameters Module
\item [\refstepcounter{mnum} \mthemnum \label{mMagMoment}:] Magnetic Moment Module
\item [\refstepcounter{mnum} \mthemnum \label{mMagField}:] Magnetic Field Module
\item [\refstepcounter{mnum} \mthemnum \label{mMagForce}:] Magnetic Force Module
\item [\refstepcounter{mnum} \mthemnum \label{mGenPoses}:] Generate Poses Module
\item [\refstepcounter{mnum} \mthemnum \label{mActMatrix}:] Actuation Matrix Module
\item [\refstepcounter{mnum} \mthemnum \label{mOptPlacement}:] Optimal Placement Module
\item [\refstepcounter{mnum} \mthemnum \label{mResults}:] Output Results Module
\item [\refstepcounter{mnum} \mthemnum \label{mControl}:] Main (Control) Module
\end{description}
